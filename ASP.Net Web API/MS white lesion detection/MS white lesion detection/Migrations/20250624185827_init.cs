        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Predictions_ScanSessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                name: "PredictionMasks",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PredictionId = table.Column<int>(type: "int", nullable: false),
                    MaskPath = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PredictionMasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PredictionMasks_Predictions_PredictionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PredictionMasks_PredictionId",
                table: "PredictionMasks",
                column: "PredictionId");

            migrationBuilder.CreateIndex(
                name: "IX_Predictions_SessionId",
                table: "Predictions",
                column: "SessionId",
                unique: true);
